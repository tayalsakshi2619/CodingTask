...
public class ApiController {
    ...
    public ResponseEntity<ApiResponse> calculateVersion2(@RequestParam(required = false) String version ,@PathVariable String num) throws InvalidInputException, NoPrimeListException {
